    ...
    <html lang="en">
      ...
      >
        <SmoothScrolling>
          ...
          <div
            className={
              "absolute left-0 hidden lg:block w-[400px] h-[400px] bg-white opacity-10 blur-3xl lg:-top-[100px]"
            }
          />
          {/*==== bg blur ===========*/}
          <div
            className={
              "absolute right-0 hidden lg:block w-[400px] h-[400px] bg-white opacity-5 blur-3xl lg:top-[700px]"
            }
          />
          <Header />
          {children}
